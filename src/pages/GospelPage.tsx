...
const GospelPage = () => {
  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      <div>
        <h1 className="text-3xl font-bold mb-6">The Gospel of Jesus Christ</h1>
        <p className="text-muted-foreground mb-6">Scripture's message of salvation through faith in Christ.</p>
      </div>
