...
import { Heart, Share2, Mail, Facebook } from "lucide-react";
      ...
      <div className="container flex flex-col items-center justify-center gap-4">
        ...
        <div className="relative flex items-center justify-center mb-3">
          ...
          >
            <Heart 
              size={18} 
              className={cn(
                "text-red-500 drop-shadow-md heart-beat heart-drip",
                showGospelMessage ? "animate-pulse" : ""
              )}
            />
        ...
        <div className="flex items-center gap-6 mt-2">
          ...
          >
            ...
            <span className="footer-social-text">Substack</span>
          </a>
          ...
          >
            ...
            <span className="footer-social-text">Twitter/X</span>
          </a>
          ...
          >
            ...
            <span className="footer-social-text">Threads</span>
          </a>
